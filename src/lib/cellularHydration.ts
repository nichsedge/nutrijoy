...
export const CELLULAR_HYDRATION_PRESETS: CellularHydrationItem[] = [
  {
    ...
    benefitId:
      'Menyeimbangkan osmolalitas seluler saat bangun tidur, menghidrasi kelenjar adrenal dan mengencangkan kulit.',
  },
  {
    id: 'coconut_water',
    ...
    benefitEn:
      'High natural bioavailable potassium flushes excess sodium water retention while hydrating dermal collagen.',
  ...
  },
  {
    ...
    benefitId:
      'Mengoptimalkan saluran aquaporin untuk menarik air langsung ke sel kulit, mencegah lemas di siang hari.',
  },
  {
    id: 'mineral_broth',
    ...
    benefitId:
      'Menyediakan prolin, glisin, dan asam amino elektrolit untuk memperkuat struktur kulit dan menenangkan usus.',
  },
];
