...
const CONFLICT_MATRIX: {
...
}[] = [
  {
    ...
    severity: 'high',
    messageEn: 'High risk of barrier damage & peeling when layering Retinoids with direct AHA/BHA acids in the same routine. Alternate nights instead.',
    messageId: 'Risiko tinggi kerusakan barrier & pengelupasan jika melapiskan Retinol bersamaan dengan AHA/BHA. Gunakan bergantian malam.'
  },
  {
    pair: ['vitamin_c', 'retinol'],
    severity: 'warning',
    messageEn: 'L-Ascorbic Acid requires acidic pH while Retinol needs neutral pH. Best used separately: Vitamin C in AM, Retinol in PM.',
    messageId: 'Vitamin C murni butuh pH asam sedangkan Retinol butuh pH netral. Pisahkan penggunaannya: Vitamin C di pagi hari, Retinol di malam hari.'
  },
  {
    pair: ['vitamin_c', 'aha_bha'],
    severity: 'caution',
    messageEn: 'Layering multiple strong direct acids can over-strip the moisture barrier. Stagger usage across different days.',
    messageId: 'Melapiskan beberapa asam kuat secara bersamaan dapat mengikis barrier kulit. Gunakan pada hari berbeda.'
  },
  {
    pair: ['benzoyl_peroxide', 'retinol'],
    severity: 'high',
    messageEn: 'Benzoyl peroxide can oxidize and deactivate retinol molecules. Use Benzoyl Peroxide in AM and Retinol in PM.',
    messageId: 'Benzoyl peroxide dapat mengoksidasi dan menonaktifkan molekul retinol. Gunakan Benzoyl Peroxide di pagi hari dan Retinol di malam hari.'
  }
];
