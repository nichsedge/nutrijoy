...
export const RESTORATIVE_YOGA_POSES: RestorativeYogaPose[] = [
  {
    ...
    icon: '🧘‍♀️',
    instructionsEn:
      'Kneel on the floor with big toes touching, sit on heels, and fold forward resting torso between thighs. Extend arms forward and rest forehead on a pillow or mat.',
    instructionsId:
      'Berlutut dengan ibu jari kaki bersentuhan, duduk di tumit, dan bungkukkan badan ke depan. Letakkan kening di atas bantal/matras dan regangkan tangan ke depan.',
  ...
  },
  {
    ...
    icon: '🦋',
    instructionsEn:
      'Lie on your back with knees bent and soles of feet together, letting knees fall open to sides. Place hands or warm heat pack on lower abdomen.',
    instructionsId:
      'Berbaring telentang, tekuk lutut dan pertemukan kedua telapak kaki, biarkan lutut terbuka ke samping. Letakkan kompres hangat di perut bawah.',
  ...
  },
  {
    ...
    icon: '✨',
    instructionsEn:
      'Sit sideways next to a wall and swing legs up against the wall as you lower your back to the floor. Arms rest relaxed at your sides with palms facing up.',
    instructionsId:
      'Duduk di samping dinding, ayunkan kaki ke atas menempel dinding sambil merebahkan punggung ke lantai. Rentangkan tangan santai di samping.',
    benefitEn:
      'Inverts venous gravity flow, drains pelvic stagnation, and profoundly calms the central nervous system.',
