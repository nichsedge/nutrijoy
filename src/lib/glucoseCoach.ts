...
export const GLUCOSE_SEQUENCING_STEPS = [
  ...
  },
  {
    ...
    descId: 'Protein dan lemak memicu hormon kenyang CCK serta memperlambat pengosongan lambung untuk menstabilkan insulin.'
  },
  {
    step: 3,
    icon: '🍚',
    ...
    descId: 'Makan karbohidrat terakhir meredam lonjakan gula darah hingga 73%, mencegah glikasi kolagen dan kantuk berlebih.'
  }
];
...
export function getGlucoseSequenceScore(check: PlateSequenceCheck) {
  ...
  if (completedCount === 3) {
    return {
      ...
      benefit: 'Maximum collagen protection! Blood sugar curve is smooth, protecting skin fibroblasts from glycation stiffness.',
      benefitId: 'Proteksi kolagen maksimal! Kurva gula darah sangat stabil, melindungi fibroblas kulit dari penuaan dini.'
    };
    ...
    return {
      ...
      benefitId: 'Kontrol gula darah mantap. Sebagian besar lonjakan gula diredam, menjaga energi stabil dan vitalitas kulit.'
    };
    ...
    return {
      ...
      benefit: 'Some protection. Try eating a small fresh salad or greens before your next meal for deeper metabolic benefits.',
      benefitId: 'Ada sedikit perlindungan. Coba makan semangkuk sayuran hijau sebelum menu utama untuk manfaat metabolik optimal.'
    };
  } else {
    return {
      score: 0,
      ...
      benefitId: 'Tips: Memulai dengan serat meredam lonjakan gula darah secara drastis tanpa perlu mengurangi makanan favoritmu.'
    };
  }
}
