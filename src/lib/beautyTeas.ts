...
export const BEAUTY_TEAS: BeautyTea[] = [
  {
    ...
    beautyBenefits:
      'Natural anti-androgen compounds gently lower free testosterone in women, significantly reducing hormonal chin breakouts and excess sebum.',
    beautyBenefitsId:
      'Senyawa anti-androgen alami menurunkan kelebihan testosteron bebas, secara nyata mengurangi jerawat hormonal di area dagu dan minyak berlebih.',
    targetPhase: 'luteal',
  ...
  },
  {
    ...
    beautyBenefits:
      'Packed with natural bioavailable Vitamin C, anthocyanins, and malic acid that directly stimulate fibroblast collagen production and restore inner skin glow.',
    beautyBenefitsId:
      'Kaya akan Vitamin C alami, antosianin, dan asam malat yang langsung memicu fibroblas memproduksi kolagen dan mengembalikan kilau alami kulit.',
  ...
  },
  {
    ...
    beautyBenefits:
      'Gingerol and anethole stimulate sluggish lymphatic fluid, soothe intestinal spasms, and flush out water retention around the eyes and abdomen.',
    beautyBenefitsId:
      'Gingerol dan anetol memperlancar aliran cairan getah bening, meredakan ketegangan usus, dan membuang retensi air di sekitar mata serta perut.',
  ...
  },
  {
    ...
    beautyBenefits:
      'Apigenin flavonoid binds to GABA receptors in the brain to reduce evening cortisol spikes, preventing stress-induced skin barrier breakdown overnight.',
    beautyBenefitsId:
      'Flavonoid apigenin menenangkan reseptor GABA di otak untuk meredakan lonjakan kortisol malam hari, melindungi barrier kulit dari kerusakan akibat stres.',
  ...
  },
  {
    ...
    beautyBenefits:
      'Minimally oxidized young tea buds contain the highest concentration of EGCG catechins, shielding skin cells against photo-aging and oxidative degradation.',
    beautyBenefitsId:
      'Pucuk teh putih muda memiliki konsentrasi katekin EGCG tertinggi, melindungi sel-sel kulit dari penuaan dini akibat paparan sinar UV.',
    targetPhase: 'follicular',
